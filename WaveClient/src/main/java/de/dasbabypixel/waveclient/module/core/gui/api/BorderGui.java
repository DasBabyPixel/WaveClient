...
public class BorderGui extends AbstractGui implements GuiWrapper {
	...
	public void draw(double mouseX, double mouseY) {
		...
		int bc = borderColor.toARGB();
		DrawHelper.drawRect(x - borderThickness, y - borderThickness, borderThickness, height + 2 * borderThickness,
				bc);
		DrawHelper.drawRect(x + width, y - borderThickness, borderThickness, height + 2 * borderThickness, bc);
		DrawHelper.drawRect(x, y - borderThickness, width, borderThickness, bc);
		DrawHelper.drawRect(x, y + height, width, borderThickness, bc);
